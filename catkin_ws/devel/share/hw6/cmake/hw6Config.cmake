...
if("TRUE" STREQUAL "TRUE")
  set(hw6_SOURCE_PREFIX /home/leeandy/catkin_ws/src/Homework/hw6)
  set(hw6_DEVEL_PREFIX /home/leeandy/catkin_ws/devel)
  set(hw6_INSTALL_PREFIX "")
  set(hw6_PREFIX ${hw6_DEVEL_PREFIX})
else()
  set(hw6_SOURCE_PREFIX "")
  set(hw6_DEVEL_PREFIX "")
  set(hw6_INSTALL_PREFIX /home/leeandy/catkin_ws/install)
...
if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'hw6' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/leeandy/catkin_ws/src/Homework/hw6/${idir}'.  ${_report}")
    endif()
...
foreach(depend ${depends})
  ...
  _list_append_deduplicate(hw6_EXPORTED_TARGETS ${${hw6_dep}_EXPORTED_TARGETS})
endforeach()
